...
namespace ViewSalesPromProducts
{
    public partial class frmViewDiscountGoods : Form
    {
        ...
        public frmViewDiscountGoods()
        {
            ...
            if (Nwuram.Framework.Settings.Connection.ConnectionSettings.GetServer().Contains("X14"))
            {
                cPriceDiscountK21.HeaderText = cPriceDiscountK21.HeaderText.Replace("K21","X14").Replace("К21", "Х14");
                cPriceRealK21.HeaderText = cPriceRealK21.HeaderText.Replace("K21", "X14").Replace("К21", "Х14");

                cPriceDiscountX14.HeaderText = cPriceDiscountX14.HeaderText.Replace("X14","K21").Replace("Х14", "К21");
                cPriceRealX14.HeaderText = cPriceRealX14.HeaderText.Replace("X14", "K21").Replace("Х14", "К21");
            }
        ...
        private void getData()
        {
            ...
            else
            {
                ...
                if (!dtData.Columns.Contains(cPriceRealK21.DataPropertyName) && dtData.Columns.Contains("Price"))
                    dtData.Columns["Price"].ColumnName = cPriceRealK21.DataPropertyName;


                if (!dtData.Columns.Contains(cPriceDiscountK21.DataPropertyName) && dtData.Columns.Contains("SalePrice"))
                    dtData.Columns["SalePrice"].ColumnName = cPriceDiscountK21.DataPropertyName;
        ...
        private void btPrint_Click(object sender, EventArgs e)
        {
            ...
            report.AddSingleValue($"Акционный товар магазина {(Nwuram.Framework.Settings.Connection.ConnectionSettings.GetServer().Contains("K21")?"K21":"X14")}", indexRow, 1);
